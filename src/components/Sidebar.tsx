  ...
  return (
    <>
      ...
      <header className="md:hidden sticky top-0 z-50 bg-[#0f0f12] border-b border-white/10 p-2.5 flex items-center justify-between gap-2">
        ...
        {/* Persistent Progress Bar + Timer on Mobile Header */}
        <div className="flex items-center gap-2 shrink-0">
          <div className="flex items-center gap-1 bg-white/5 border border-white/10 px-2 py-1 rounded-md">
            <div className="w-10 sm:w-14 h-1.5 rounded-full bg-white/10 overflow-hidden">
          ...
          <button
            onClick={() => onOpenTimer()}
            className="flex items-center gap-1 px-2.5 py-1 rounded-md bg-amber-500 text-stone-950 text-[11px] font-black transition-all shadow-xs"
          >
          ...
          <button
            ...
            className="p-1.5 rounded-lg bg-white/10 text-white/70 hover:text-white border border-white/10 transition-colors"
          >
