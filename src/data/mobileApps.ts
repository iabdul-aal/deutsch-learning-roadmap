...
export const MOBILE_APPS_DATA: MobileAppsData = {
  title: "A1 Mobile Apps Directory & Offline Self-Study Companion",
  description: "Curated directory of top-rated mobile applications for practicing German vocabulary, listening, shadowing, and grammar on Android & iOS.",
  ...
  apps: [
    {
      ...
      freeTrial: true,
      offline: true,
      bestFor: "Long-term Vocabulary & Goethe A1 Word Deck Spaced Repetition",
    ...
    },
    {
      ...
      category: "Interactive Story & Immersion",
      platform: "Android / iOS / Web",
      rating: "4.8 / 5.0",
      freeTrial: true,
      offline: true,
      bestFor: "Immersive A1 Storytelling & Interactive Video Exercises",
    ...
    },
    {
      ...
      freeTrial: true,
      offline: false,
      bestFor: "Native Speaker Video Pronunciation & Shadowing Drills",
    ...
    },
    {
      ...
      freeTrial: true,
      offline: false,
      bestFor: "Casual Daily Streak Maintenance & Sentence Repetition",
    ...
    },
    {
      ...
      recommendedUse: "Week 4+: Practice simple text & voice message exchanges with native speakers.",
