...
export const VIDEOS: Record<string, VideoResource> = {
  ...
  'pog_a1_crash': { videoId: 'S8ukFF6SdGk', title: 'A1 - Lesson 2 | Common Phrases | Revised | German for beginners | Learn German', channelName: 'Learn German', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_a2_crash': { videoId: 'DnewKMVyflE', title: 'A2 - Lesson 1 | Introducing yourself | sich vorstellen | German for beginners', channelName: 'Learn German', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_wo_wohin': { videoId: 'dTdc9sPFQig', title: 'Learn German | German Grammar |  Wo? oder Wohin? | Part 1 | A1 | A2', channelName: 'Learn German', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_body_parts': { videoId: 'QISEqVtVS98', title: 'TOP 10 Hardest German Words! (Part 1) -  Learn German Vocabulary #germanpronunciation', channelName: 'LEARN GERMAN HUB', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_clothes': { videoId: 'FaX2vGUocj0', title: 'German Vocab You Need To Know! (School Supplies) Part 2!', channelName: 'Learn Languages with Isa', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_furniture': { videoId: '35Afp-fqoQ8', title: 'Learn Body parts name in German #germanpronunciation #germanworld', channelName: 'German World', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_prepositions': { videoId: 'Lg5P2w_Ro1c', title: 'Deutsch lernen (A2): Ganzer Film auf Deutsch - \"Nicos Weg\" | Deutsch lernen mit Videos | Untertitel', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_word_order': { videoId: 'jR4XeQxwGHQ', title: 'Basic Word Order in German', channelName: 'mugridge language', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_future_tense': { videoId: 'uBAnVYX9VeI', title: 'Relativsatz and Relativpronomen in German | Nominativ, Akkusativ, Dativ & Genitiv | German A2', channelName: 'Five Minute German', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_modal_verbs': { videoId: 'W9coIzRQGh4', title: 'Learn German with Us at the Supermarket (for Advanced Beginners)', channelName: 'Easy German', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_s-e4cXgmEy4': { videoId: 's-e4cXgmEy4', title: 'GERMAN PRONUNCIATION 1: The German Alphabet 🔠🔠🔠', channelName: 'Learn German with Anja', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_cTJ1KFzmhbc': { videoId: 'cTJ1KFzmhbc', title: 'Deutsch lernen (A1) | Nicos Weg | Folge 70: Beim Arzt', channelName: 'Deutsch lernen mit der DW', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_ilp0CwKxdbY': { videoId: 'ilp0CwKxdbY', title: 'Deutsch lernen (A1) | Nicos Weg | Folge 71: Gute Besserung!', channelName: 'Deutsch lernen mit der DW', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_VWomWeeqsAk': { videoId: 'VWomWeeqsAk', title: 'Deutsch lernen (A1) | Nicos Weg | Folge 72: Nehmen Sie …', channelName: 'Deutsch lernen mit der DW', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_mkXWqvL3-hA': { videoId: 'mkXWqvL3-hA', title: 'Deutsch lernen (A1) | Nicos Weg | Folge 73: Meine Heimat', channelName: 'Deutsch lernen mit der DW', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_0b66BzvKgMY': { videoId: '0b66BzvKgMY', title: 'Deutsch lernen (A1) | Nicos Weg | Folge 69: Geht es dir gut?', channelName: 'Deutsch lernen mit der DW', level: 'A1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_3KgYG5t4lPo': { videoId: '3KgYG5t4lPo', title: 'الدرس رقم 1 - A2 -  اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_vGLaZH-TZOE': { videoId: 'vGLaZH-TZOE', title: '學德語 extra deutsch: Sam hat ein Date (3/13) - 看影片學德語', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_3ywwqxMVJkI': { videoId: '3ywwqxMVJkI', title: 'الدرس رقم 2 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_mMr4gozaf_s': { videoId: 'mMr4gozaf_s', title: 'Extra auf Deutsch: Sam Geht Einkaufen (2/13) subtitles - 到比恩學德文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_460IBUb0rno': { videoId: '460IBUb0rno', title: 'الدرس رقم 3 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_dRga5jIMjBo': { videoId: 'dRga5jIMjBo', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 5: Geld ist für mich …', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_WB4YmgiRULw': { videoId: 'WB4YmgiRULw', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 2: Angekommen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_A1k6ZjKFycM': { videoId: 'A1k6ZjKFycM', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 3: Pläne machen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_ZPQepR4B8eo': { videoId: 'ZPQepR4B8eo', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 1: Lebenslinien', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_iGovllrEsF8': { videoId: 'iGovllrEsF8', title: 'extra german  with subtitles: Sam\'s Ankunft (1/13) - 學德文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_J7j31w8UT2c': { videoId: 'J7j31w8UT2c', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 4: Sprichst du Deutsch?', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_geYuMJBnDSs': { videoId: 'geYuMJBnDSs', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 6: Mein Bankkonto', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_5Sa4-iIo_QQ': { videoId: '5Sa4-iIo_QQ', title: 'الدرس رقم 5 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_aYHyfDlAzp8': { videoId: 'aYHyfDlAzp8', title: 'الدرس رقم 4 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_MUcfiKAJUGg': { videoId: 'MUcfiKAJUGg', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 12: Alten- und Pflegeheim', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_Xw7Kv0o5a1Y': { videoId: 'Xw7Kv0o5a1Y', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 11: Generationen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_uOcZq9rS13Y': { videoId: 'uOcZq9rS13Y', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 9: Familiengeschichten', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_Tor-mPRS3j4': { videoId: 'Tor-mPRS3j4', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 10: Personen beschreiben', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_tNY9TNnQC6E': { videoId: 'tNY9TNnQC6E', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 7: Rechnungen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_8qEZkXf9S2A': { videoId: '8qEZkXf9S2A', title: '補德文 extra au deutsch: Sam Sucht Einen Job (4/13)字幕 - 比恩', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_0Uqr9wmQ0es': { videoId: '0Uqr9wmQ0es', title: '德語老師 推薦extra German: Ein Star ist geboren (5/13) - 學德文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_n_l-rfcG5Uo': { videoId: 'n_l-rfcG5Uo', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 8: Am Bankautomaten', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_rTgkeG4IJJw': { videoId: 'rTgkeG4IJJw', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 17: Unterwegs', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_cjF8atTt7IU': { videoId: 'cjF8atTt7IU', title: 'الدرس رقم 7 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_sOaWFjMkDpg': { videoId: 'sOaWFjMkDpg', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 15: Kinder', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_JmjnyhFLXKg': { videoId: 'JmjnyhFLXKg', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 13: Wohngemeinschaft', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_x_JD4pMjRME': { videoId: 'x_JD4pMjRME', title: '德文學習: extr@deutsch episode 6 (6/13) - 學德文 - 比恩語文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_C9m4I49cRv4': { videoId: 'C9m4I49cRv4', title: 'الدرس رقم 6 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_iU7swr8-hk0': { videoId: 'iU7swr8-hk0', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 19: Bahnreisen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_0ijgOLUE3NQ': { videoId: '0ijgOLUE3NQ', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 18: Im Hotel', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_i4IJP4s14k8': { videoId: 'i4IJP4s14k8', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 14: Nachbarschaft', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_qqxSuoX0gzw': { videoId: 'qqxSuoX0gzw', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 20: Der Ticketautomat', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_29d2dcAU_yc': { videoId: '29d2dcAU_yc', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 24: Das meinen Sie nicht ernst!', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_8tgE0aw2Z1s': { videoId: '8tgE0aw2Z1s', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 25: Das macht mir Spaß!', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_oEWakpD2JaQ': { videoId: 'oEWakpD2JaQ', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 21: Alltag und Freizeit', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_hU4w7y2cwJg': { videoId: 'hU4w7y2cwJg', title: '德文補習 extr@ Deutsch 8:Kusine der Vermieterin (8/13) - 比恩語文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_PrrbATyrg08': { videoId: 'PrrbATyrg08', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 23: Das hört sich gut an!', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_x7EYg9Z3a1o': { videoId: 'x7EYg9Z3a1o', title: 'الدرس رقم 9 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog__w9c-vPI-bY': { videoId: '_w9c-vPI-bY', title: '德文教學 extra auf deutsch: Hochzeitspläne (13/13) - 比恩語文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_I3SUjQJnm7k': { videoId: 'I3SUjQJnm7k', title: 'الدرس رقم 12 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_CRga4lKBmKI': { videoId: 'CRga4lKBmKI', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 31: Mit freundlichen Grüßen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_xuVnMMMztx0': { videoId: 'xuVnMMMztx0', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 30: Das Internet', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_Y4y-gKdIW68': { videoId: 'Y4y-gKdIW68', title: 'الدرس رقم 11 - A2 - اللغة الألمانية', channelName: 'Future Learning', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_UXakAD1X7uc': { videoId: 'UXakAD1X7uc', title: '德語小班會話 extr@ german: Verrückt nach Fußball (12/13) - 輕鬆學德語', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_aGW9URYStCA': { videoId: 'aGW9URYStCA', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 32: Reklamation', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_cz7f5n1DDjA': { videoId: 'cz7f5n1DDjA', title: '德文老師推薦: extr@deutsch: Ferienzeit (11/13) - 比恩語文', channelName: 'BienLanguages', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_IIKgD8vCV6M': { videoId: 'IIKgD8vCV6M', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 27: Das macht mir Sorgen!', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_10T22TlEO4k': { videoId: '10T22TlEO4k', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 28: Das ist mir wichtig!', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_YMUUh71lMb0': { videoId: 'YMUUh71lMb0', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 29: Immer und überall', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_gCkFdPgl6Qw': { videoId: 'gCkFdPgl6Qw', title: 'Deutsch lernen (A2) | Nicos Weg | Folge 33: Essen gehen', channelName: 'Deutsch lernen mit der DW', level: 'A2', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_Cy4_jtJC1HU': { videoId: 'Cy4_jtJC1HU', title: 'How do Germans relax? | Easy German 217', channelName: 'Easy German', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_6gDEwBEd0WY': { videoId: '6gDEwBEd0WY', title: 'B1 Lektion 1 Grammatik - Adjektive als Nomen und N-Deklination', channelName: 'Deutsch mit Hend - الألمانية مع هند ', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_o1zJ-BNQrU0': { videoId: 'o1zJ-BNQrU0', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 1: Berufsberatung', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_GwhGWqlGUUY': { videoId: 'GwhGWqlGUUY', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 2: Meine Muttersprache', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_2itTid0YMtw': { videoId: '2itTid0YMtw', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 3: Bei der Arbeit', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_VfDOzaihbH8': { videoId: 'VfDOzaihbH8', title: 'Deutsch lernen (A2) | Das Deutschlandlabor | Folge 03: Fußball', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_kqKWXsEwkPI': { videoId: 'kqKWXsEwkPI', title: 'Deutsch lernen (A2) | Das Deutschlandlabor | Folge 02: Mode', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_du_3kNU5Fkc': { videoId: 'du_3kNU5Fkc', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 4: Zukunftspläne', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_jgdPdeQZ3T8': { videoId: 'jgdPdeQZ3T8', title: 'Deutsch lernen (A2) | Das Deutschlandlabor | Folge 01: Schule', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_EZo4Eja_36Y': { videoId: 'EZo4Eja_36Y', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 5: Zu wenig Zeit?', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_3P7t_K9vH4g': { videoId: '3P7t_K9vH4g', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 11: Die Mauer', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_kJnZ2DEbax8': { videoId: 'kJnZ2DEbax8', title: 'How Often Do You Lie? (from Vienna) | Easy German 427', channelName: 'Easy German', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_LBtncHYWs9M': { videoId: 'LBtncHYWs9M', title: 'B1 Lektion 3 Grammatik -  Relativpronomen', channelName: 'Deutsch mit Hend - الألمانية مع هند ', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_5YtHNczWwAw': { videoId: '5YtHNczWwAw', title: 'الدرس رقم 3 - B1 - اللغة الألمانية', channelName: 'Future Learning', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_M4x5Xy94aoc': { videoId: 'M4x5Xy94aoc', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 8: Jetzt oder nie', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_Gf-CF34SJJU': { videoId: 'Gf-CF34SJJU', title: 'Deutsch lernen (B1) | Nicos Weg | Folge  10: Krieg und Frieden', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_AqNvnBHO_78': { videoId: 'AqNvnBHO_78', title: 'الدرس رقم 4 - B1 - اللغة الألمانية', channelName: 'Future Learning', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_0FiFNWpFVYc': { videoId: '0FiFNWpFVYc', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 9: Heimat', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_CgMWnmoKiDc': { videoId: 'CgMWnmoKiDc', title: 'Deutschlandlabor – Folge 6: Wohnen', channelName: 'Goethe-Institut', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_5ejGKY5tD8I': { videoId: '5ejGKY5tD8I', title: 'Deutsch lernen (A2) | Das Deutschlandlabor | Folge 05: Wandern', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_oKCWlrpecbM': { videoId: 'oKCWlrpecbM', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 12: Wiedervereinigung', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_LHGmpGgBZnw': { videoId: 'LHGmpGgBZnw', title: 'How Many Hours do Germans Work per Week? | Easy German 210', channelName: 'Easy German', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_3ReeoAxzjLI': { videoId: '3ReeoAxzjLI', title: 'B1 Lektion 4 Grammatik  -  Obwohl und Trotzdem', channelName: 'Deutsch mit Hend - الألمانية مع هند ', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'pog_WcAZQz0A-1U': { videoId: 'WcAZQz0A-1U', title: 'B1 Lektion 5 Grammatik -   Futur I', channelName: 'Deutsch mit Hend - الألمانية مع هند ', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_Kc4CQUxZnd8': { videoId: 'Kc4CQUxZnd8', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 13: Alltagsprobleme', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_Co-VwHBM1ZY': { videoId: 'Co-VwHBM1ZY', title: 'What are you reading? | Easy German 214', channelName: 'Easy German', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_qFDZu0CDHYs': { videoId: 'qFDZu0CDHYs', title: 'What do you like about your profession? | Easy German 205', channelName: 'Easy German', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_XzQS1pbwyjE': { videoId: 'XzQS1pbwyjE', title: 'Deutsch lernen (A2) | Das Deutschlandlabor | Folge 10: Migration', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_FL0n-FMuxhA': { videoId: 'FL0n-FMuxhA', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 14: Geldprobleme', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  'pog_DGAUVpI0UEc': { videoId: 'DGAUVpI0UEc', title: 'Deutsch lernen (B1) | Nicos Weg | Folge 17: Jobsuche', channelName: 'Deutsch lernen mit der DW', level: 'B1', durationMinutes: 15, language: 'german', type: 'lesson' },
  ...
  'hend_-JDEv3duTPY': { videoId: '-JDEv3duTPY', title: 'تعليم اللغة العربية لغير الناطقين بها من الألمان (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_-es6J6fzu4c': { videoId: '-es6J6fzu4c', title: 'Startbereit A1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_0YIkxiM3ueM': { videoId: '0YIkxiM3ueM', title: 'Barmherzigkeit – Warum sie der Schlüssel zu innerem Glück ist? (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_142WnuFktzA': { videoId: '142WnuFktzA', title: 'A2 Wortschatz - Lektion 9 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_1DUOt91Oofc': { videoId: '1DUOt91Oofc', title: 'B2 Kapitel 7 Teil 6 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3-RETJrbOwA': { videoId: '3-RETJrbOwA', title: 'B2 Kapitel 7 Teil 5 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_35Z9wmLEE7c': { videoId: '35Z9wmLEE7c', title: 'الدرس رقم 13 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3AYnL1sIffM': { videoId: '3AYnL1sIffM', title: 'A2 Wortschatz - Lektion 13 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3C_ATtrVKyE': { videoId: '3C_ATtrVKyE', title: 'الدرس رقم 8 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3eIx4M7oymI': { videoId: '3eIx4M7oymI', title: 'الدرس رقم 24 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3lBIxpJvuVU': { videoId: '3lBIxpJvuVU', title: 'الحلقة الأولى - مراجعة المستوى A1 في 8 حلقات (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3tfct-fUEE8': { videoId: '3tfct-fUEE8', title: 'A2 Wortschatz - Lektion 2 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_3wAqYDlmghY': { videoId: '3wAqYDlmghY', title: 'B2 Kapitel 9 Teil 4 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_4gb1ORkPzOg': { videoId: '4gb1ORkPzOg', title: 'Lektion 14 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_4mXhEjXED6s': { videoId: '4mXhEjXED6s', title: 'كلام مهم شويتين ❤️ (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_4rdJVDsepag': { videoId: '4rdJVDsepag', title: 'Lektion 24 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_4z8KefDnKSI': { videoId: '4z8KefDnKSI', title: 'Lektion 2  - A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_5dXFsjBXwZQ': { videoId: '5dXFsjBXwZQ', title: 'الدرس رقم 10 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_5sgmh9OWpwA': { videoId: '5sgmh9OWpwA', title: 'الدرس رقم 22 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_6PwEJwsPYEA': { videoId: '6PwEJwsPYEA', title: 'B2 Kapitel 10 Teil 4 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_7URsCpZ4xtI': { videoId: '7URsCpZ4xtI', title: 'A2 Wortschatz - Lektion 10 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_8Cs37_8qghM': { videoId: '8Cs37_8qghM', title: 'B2 Kapitel 9 Teil 2 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_90z7QYf7lSY': { videoId: '90z7QYf7lSY', title: 'A2 Wortschatz - Lektion 24 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_9PpOBJa9Mvs': { videoId: '9PpOBJa9Mvs', title: '1  das Alphabet (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_A-NJ5SU-ToA': { videoId: 'A-NJ5SU-ToA', title: 'الحلقة الأولى - مراجعة المستوى A2 في 6 حلقات (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_AVMl1NdFbGo': { videoId: 'AVMl1NdFbGo', title: 'الدرس رقم 15 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_BBZwAwsGt_Y': { videoId: 'BBZwAwsGt_Y', title: 'Lektion 3 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_B_aIu0i5hPg': { videoId: 'B_aIu0i5hPg', title: 'Lektion 12 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_C-kWQynNtKs': { videoId: 'C-kWQynNtKs', title: 'A2 Wortschatz - Lektion 19 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_CObYIJdY6Hs': { videoId: 'CObYIJdY6Hs', title: 'Lektion 10 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_Cg_9ozupIrs': { videoId: 'Cg_9ozupIrs', title: 'الدرس رقم 18 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_E9ZWHsoxS1w': { videoId: 'E9ZWHsoxS1w', title: 'Geduld im Islam: Wie man stark bleibt in schweren Zeiten (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_EQOsS6KjH2E': { videoId: 'EQOsS6KjH2E', title: 'خايف على اولادي من ألمانيا  (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_EvEZh5mQTs0': { videoId: 'EvEZh5mQTs0', title: 'A2 Wortschatz - Lektion 7 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_FTnw9dYeaac': { videoId: 'FTnw9dYeaac', title: 'A2 Wortschatz - Lektion 3 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_FqAWJk3dc30': { videoId: 'FqAWJk3dc30', title: 'Lektion 9 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_G2xNRY1jMTk': { videoId: 'G2xNRY1jMTk', title: 'أساسيات اللغة الألمانية  - الجزء الأول (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_GJfGrDu5t5E': { videoId: 'GJfGrDu5t5E', title: 'Lektion 1 - Wortschatz A1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_IcfHbvoIEd8': { videoId: 'IcfHbvoIEd8', title: 'Lektion 16 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_J2xg7IwlWYc': { videoId: 'J2xg7IwlWYc', title: 'A2 Wortschatz - Lektion 22 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_JPGfSxBbf5E': { videoId: 'JPGfSxBbf5E', title: 'A2 Wortschatz - Lektion 6 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_JcVLvkMMKLk': { videoId: 'JcVLvkMMKLk', title: 'الدرس رقم 9 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_JtYru7_rWhw': { videoId: 'JtYru7_rWhw', title: 'Lektion 4 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_KbtH_iPTJg4': { videoId: 'KbtH_iPTJg4', title: 'B2 Kapitel 8 Teil 5 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_Kr8SJLIjgBc': { videoId: 'Kr8SJLIjgBc', title: 'B2 Kapitel 10 Teil 3 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_KxIjponkbY8': { videoId: 'KxIjponkbY8', title: 'Lektion 13 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_LQoMG2pQubc': { videoId: 'LQoMG2pQubc', title: 'الدرس رقم 12 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_LrdTHcQaTJY': { videoId: 'LrdTHcQaTJY', title: 'A2 Wortschatz - Lektion 8 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_MHFvl3IGXW4': { videoId: 'MHFvl3IGXW4', title: 'Lektion 5 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_OAJ4hz540Po': { videoId: 'OAJ4hz540Po', title: 'B2 Kapitel 8 Teil 2 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_P-Q1MRhz5OE': { videoId: 'P-Q1MRhz5OE', title: 'فيديو تعريفي بكتب Startbereit - بصرف النظر عن صريخ يونس :) (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_PDoHTvGLleE': { videoId: 'PDoHTvGLleE', title: 'A2 Wortschatz - Lektion 17- القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_PVb0U2HIzPA': { videoId: 'PVb0U2HIzPA', title: 'A2 Wortschatz - Lektion 20 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_RAyWsgu9-bQ': { videoId: 'RAyWsgu9-bQ', title: 'A2 Wortschatz - Lektion 14 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_Shxrztpz9D4': { videoId: 'Shxrztpz9D4', title: 'B2 Kapitel 8 Teil 3 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_T1U9J_RyHOs': { videoId: 'T1U9J_RyHOs', title: 'Ramadan (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_T7mx4qsmevc': { videoId: 'T7mx4qsmevc', title: 'A2 Wortschatz - Lektion 18 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_T7rO1sAijH8': { videoId: 'T7rO1sAijH8', title: 'A2 Wortschatz - Lektion 5 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_TPvYYsr6KbE': { videoId: 'TPvYYsr6KbE', title: 'الدرس رقم 24 - A1 - اللغة الألمانية للمبتدئين (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_TRv3DFHbej8': { videoId: 'TRv3DFHbej8', title: 'الدرس رقم 17 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_TZww485ncl8': { videoId: 'TZww485ncl8', title: '10- Geschmack und Vorlieben - الأذواق والميول (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_UYlpZHKAzyE': { videoId: 'UYlpZHKAzyE', title: 'A2 Wortschatz - Lektion 4 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_VUcAEwtX3rU': { videoId: 'VUcAEwtX3rU', title: 'الدرس رقم 7 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_Vh1R2_w0SJ0': { videoId: 'Vh1R2_w0SJ0', title: 'أساسيات اللغة الألمانية -  الجزء الثاني (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_ViwkVQrPkqE': { videoId: 'ViwkVQrPkqE', title: 'B2 Kapitel 9 Teil 1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_W7M3QE-YshM': { videoId: 'W7M3QE-YshM', title: 'B2 Kapitel 9 Teil 6 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_W_X0kowNIH0': { videoId: 'W_X0kowNIH0', title: 'Lektion 18 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_XIYGYvpIh64': { videoId: 'XIYGYvpIh64', title: 'Lektion 6 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_XeI2QXB-zxs': { videoId: 'XeI2QXB-zxs', title: 'الدرس رقم 11 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_XzLoqMVx3lQ': { videoId: 'XzLoqMVx3lQ', title: 'الدرس رقم 20 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_ZMEAiRFAWgM': { videoId: 'ZMEAiRFAWgM', title: 'B2 Kapitel 10 Teil 6 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_Zmzw6qxs0Zo': { videoId: 'Zmzw6qxs0Zo', title: 'B2 Kapitel 10 Teil 1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_aVqq_FL0JHo': { videoId: 'aVqq_FL0JHo', title: 'الدرس رقم 19 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_baOu0ZY7JoQ': { videoId: 'baOu0ZY7JoQ', title: 'Lektion 22 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_d8HFkxDJdSo': { videoId: 'd8HFkxDJdSo', title: 'Lektion 17 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_dQPeb5wVYlM': { videoId: 'dQPeb5wVYlM', title: 'B2 Kapitel 8 Teil 6 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_eIYQJjEIamU': { videoId: 'eIYQJjEIamU', title: 'Lektion 7 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_eLQbQcMUGXw': { videoId: 'eLQbQcMUGXw', title: '2  die Wechselpräpositionen (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_eSmvVgR283c': { videoId: 'eSmvVgR283c', title: 'Lektion 15 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_fVLwkiiyWHw': { videoId: 'fVLwkiiyWHw', title: 'B2 Kapitel 8 Teil 4 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_fX22QOgIcnE': { videoId: 'fX22QOgIcnE', title: 'B2 Kapitel 9 Teil 3 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_guULDAYy81c': { videoId: 'guULDAYy81c', title: 'B2 Kapitel 8 Teil 1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_hS16h5GNATc': { videoId: 'hS16h5GNATc', title: 'B2 Kapitel 10 Teil 5 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_jFXSBh0xf6c': { videoId: 'jFXSBh0xf6c', title: 'A2 Wortschatz - Lektion 11 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_kwd-Y6JDaNE': { videoId: 'kwd-Y6JDaNE', title: 'ازاي اقوي اللغة عندي؟ (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_lh20OL5SO48': { videoId: 'lh20OL5SO48', title: 'A2 Wortschatz - Lektion 16 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_oIShruVC1go': { videoId: 'oIShruVC1go', title: 'B2 Kapitel (1) - Heimat_ Auftakt (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_oM6KPlHo5ao': { videoId: 'oM6KPlHo5ao', title: 'Lektion 19 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_p3GpvD0uLH4': { videoId: 'p3GpvD0uLH4', title: 'A2 Wortschatz - Lektion 1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_p3jVxz-hp6Y': { videoId: 'p3jVxz-hp6Y', title: 'الدرس رقم 21 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_pSF_tOGvc3s': { videoId: 'pSF_tOGvc3s', title: 'Lektion 20 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_qwMXSY8hSA4': { videoId: 'qwMXSY8hSA4', title: 'الدرس رقم 16 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_rxbgpcevpUA': { videoId: 'rxbgpcevpUA', title: 'A2 Wortschatz - Lektion 12 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_szHs1GO2ezM': { videoId: 'szHs1GO2ezM', title: 'B2 Kapitel 10 Teil 2 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_tCw0WOtkwRE': { videoId: 'tCw0WOtkwRE', title: 'Lektion 11 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_tiNSgqk2mKE': { videoId: 'tiNSgqk2mKE', title: 'Lektion 21 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_ttPXr_GxFAc': { videoId: 'ttPXr_GxFAc', title: 'A2 Wortschatz - Lektion 15 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_u01gZIaoJ0c': { videoId: 'u01gZIaoJ0c', title: 'Lektion 23 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_uKy9N33s0Sg': { videoId: 'uKy9N33s0Sg', title: 'لقاء مع شباب جامعة السويس (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_vIXjLnvrDY8': { videoId: 'vIXjLnvrDY8', title: 'A2 Wortschatz - Lektion 23 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_vkNkIevrfNs': { videoId: 'vkNkIevrfNs', title: 'Lektion 8 -  A1 Wortschatz (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_w9IudPRz2xk': { videoId: 'w9IudPRz2xk', title: 'الحل النهائي لمشكلة الأكوزاتيف والداتيف - لايف رقم 1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_y1VqPwhWJrM': { videoId: 'y1VqPwhWJrM', title: 'الدرس رقم 14 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_y3CVFM_SA4Q': { videoId: 'y3CVFM_SA4Q', title: 'B2 Kapitel 1 Teil 3 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_z7KxP54QBoM': { videoId: 'z7KxP54QBoM', title: 'الدرس رقم 23 - B1 - اللغة الألمانية (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'B1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_znbJs4JlnTc': { videoId: 'znbJs4JlnTc', title: 'A2 Wortschatz - Lektion 21 - القاموس الناطق (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A2', durationMinutes: 25, language: 'arabic', type: 'lesson' },
  'hend_zwXFSW2b7z8': { videoId: 'zwXFSW2b7z8', title: 'إعلان كتاب Startbereit A1 (Deutsch mit Hend)', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 25, language: 'arabic', type: 'lesson' },
