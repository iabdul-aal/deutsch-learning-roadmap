...
export const VIDEOS: Record<string, VideoResource> = {
  ...
  hend_intro:         { videoId: 'WMvCXVorOsg', title: 'A1 Course Overview & Introduction', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 20, language: 'arabic', type: 'lesson', viewsApprox: '500K+' },
  hend_alphabet:      { videoId: 'A_c1V5h5a_k', title: 'Das Alphabet – German Alphabet & Phonetics', channelName: 'Deutsch mit Hend', level: 'A1', durationMinutes: 35, language: 'arabic', type: 'lesson' },
