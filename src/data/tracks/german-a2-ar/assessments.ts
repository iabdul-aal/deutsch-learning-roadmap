...
export const ASSESSMENTS_DATA_A2 = {
  ...
  assessments: [
    ...
    {
      weekNumber: 2,
      title: "Week 2: Reflexive Verbs and Daily Routines",
      timeMinutes: 25,
      questions: [
    ...
    {
      weekNumber: 4,
      title: "Week 4: Perfekt (Past Tense) - Regular and Irregular Verbs",
      timeMinutes: 30,
      questions: [
    ...
    {
      weekNumber: 6,
      title: "Week 6: Futur I and Appointments (Arzt, Bank, Amt)",
      timeMinutes: 25,
      questions: [
